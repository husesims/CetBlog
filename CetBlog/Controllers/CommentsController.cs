...
namespace CetBlog.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserFullName,Content,ParentCommentId,CreatedDate,PostId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserFullName,Content,ParentCommentId,CreatedDate,PostId")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
